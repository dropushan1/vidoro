      ...
      <div className="container mx-auto px-4 md:px-10 lg:px-20">
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed">
              <li>
                ...
                <strong className="text-foreground">Massive Audience:</strong>{" "}
                India has the largest internet user base globally, with the
                highest number of YouTube users.
              </li>
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Untapped Potential:</strong>{" "}
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 mt-3 text-muted-foreground leading-relaxed">
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Translation:</strong> Accurate
                translation of your English video scripts into Hindi.
              </li>
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Voiceovers:</strong>{" "}
                Professional Hindi voiceover recordings tailored to your
                content.
              </li>
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Video Editing:</strong>{" "}
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 mt-3 text-muted-foreground leading-relaxed">
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Experienced Team:</strong> We
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 mt-3 text-muted-foreground leading-relaxed">
              ...
              <li>
                ...
                <ul className="list-disc list-inside space-y-2 mt-3 ml-6 text-muted-foreground leading-relaxed">
                  <li>
                    {/* Changed text-gray-200 to text-foreground */}
                    <strong className="text-foreground">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed">
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Secure Handling:</strong> We
                will handle your video assets and files with complete care and
                professionalism.
              </li>
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Storage:</strong> We will
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 mt-3 text-muted-foreground leading-relaxed">
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Plus Pack:</strong> $147 (60 Minutes)
              </li>
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Pro Pack:</strong> $378 (180 Minutes) - Most Popular
              </li>
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Elite Pack:</strong> $693 (360 Minutes)
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed">
              ...
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">License:</strong> By
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed">
              <li>
                {/* Changed text-gray-200 to text-foreground */}
                <strong className="text-foreground">Lower Indian CPM:</strong> The
