...
export default function HowVidoroWorks() {
  ...
  const particlesLoaded = useCallback(
    async (container: Container | undefined) => {
      // console.log(container); // Optional logging
    },
    [],
  );
  ...
  return (
    // Apply relative positioning and remove min-h-screen here
    <div className="bg-[#0A0A0F] text-white relative overflow-x-hidden">
      {/* Particle Background - Ensure it's behind content */}
      <Particles
        id="tsparticles"
        init={particlesInit}
        ...
        // Use z-0 to place particles behind everything else
        className="absolute inset-0 z-0"
      />

      {/* Main Content Wrapper - Must have relative and higher z-index */}
      <div className="relative z-10">
        ...
        <section className="relative overflow-hidden py-20 px-4 md:px-6 lg:py-32">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="relative my-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                ...
                >
                  ...
                  <p className="text-gray-400">
                  We Translate, Optimize, and Upload to Your Hindi Channel.
                  </p>
                  <div className="mt-4 w-full h-40 bg-gray-800 rounded-lg overflow-hidden relative">
            ...
            {/* First Contact Us Button - Add onClick */}
            <div className="max-w-2xl mx-auto text-center mt-16 mb-10"> {/* Added mt-16 */}
              <p className="text-gray-300 mb-8">
                Create a new YouTube channel, grant Vidoro "Manager/Editor" role, and
                we'll handle the rest. Your videos will be automatically
                translated and uploaded to your Hindi channel within 8-24 hours.
              </p>
              <Button
                size="lg"
                ...
                onClick={handleContactClick} // Add onClick handler here
              >
          ...
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-16 text-left">
              ...
              <span className="block text-lg font-normal text-gray-400 mt-2">
                A detailed look at our simple process
              </span>
            </h2>
            ...
            <div className="space-y-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="md:col-span-9">
                    <h3 className="text-2xl font-bold mb-4 flex items-center">
                      ...
                      Grant Us Manageer/Editor Access
                    </h3>
                    <p className="text-gray-300 mb-4">
                      Next, grant Vidoro the "Manageer/Editor" role on your new Hindi
                      channel. This secure permission allows us to upload
                      translated videos without requiring your hindi channels password or full
                      account access.
                    </p>
                    <div className="bg-gray-900 p-4 rounded-lg border border-gray-800 mb-4">
                      <p className="text-sm text-gray-400 font-medium mb-2">
                        ...
                        will have limited access and cannot:
                      </p>
                      <ul className="text-sm text-gray-400 space-y-1 list-disc pl-5">
                        <li>Manage channel permissions.</li>
                        <li>Delete the channel or already published content</li>
                      </ul>
                    </div>
              ...
              {/* Step 4 */}
              <div className="relative"> {/* No line needed after the last step */}
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                  <div className="md:col-span-3 flex justify-center md:justify-start">
                    <div className="w-24 h-24 bg-blue-900/30 rounded-full flex items-center justify-center relative z-10">
                  ...
                  <div className="md:col-span-9">
                    ...
                    <p className="text-gray-300 mb-4">
                      Think of Vidoro as an extension of your team. We stay
                      connected through your preferred channels, providing updates,
                      sharing performance data, and remaining available for
                      feedback or strategic discussions to help optimize your Hindi
                      channel's success.
                    </p>
                    <div className="bg-gray-900 p-4 rounded-lg border border-gray-800">
                      <p className="text-sm text-gray-400">
                        We proactively share insights and reports, ensuring you're
                        always in the loop about your channel's progress and the
